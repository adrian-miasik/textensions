...
namespace Textensions.Core
{
	public class TextensionEffects : MonoBehaviour
	{
		...
		/// </summary>
		private readonly List<int> keysToClean = new List<int>();
		...
		private List<int> DetermineWhatCharactersToAffect(Effect _fx)
		{
		...
		/// </summary>
		/// <param name="_characterIndex">The character you want to target on this textension.</param>
		/// <param name="_effectToRemove">The effect you want to remove from this character.</param>
