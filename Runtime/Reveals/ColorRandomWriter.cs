...
namespace Textensions.Reveals
{
	...
	/// The way we are revealing each character is by altering the color of the vertices on the characters mesh. Each character mesh has 4 vertices and we are
	/// changing the color32 of each corner at once.
	/// </summary>
